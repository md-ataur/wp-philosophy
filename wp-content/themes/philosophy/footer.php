...
<section class="s-extra">
    ...
    <div class="row bottom tags-wrap">
        <div class="col-full tags">          
            <!-- Taxonomy Tags start  -->
            <?php
            $philosophy_tag_heading = apply_filters( "philosophy_tag_heading", __("Tags","philosophy") );
            $philosophy_tag_terms = apply_filters( "philosophy_tag_terms", get_tags() );
            ?>

            <h3><?php echo esc_html($philosophy_tag_heading); ?></h3>
            <div class="tagcloud">
                <?php 
                //the_tags(' ', ' ', ' '); 
                ...
                */
                ...
                foreach ($philosophy_tag_terms as $term) {
        ...
        <div class="row">            
            ...
            <div class="col-five md-full end s-footer__subscribe">                    
                ...
                if (is_active_sidebar( "footer-section" )) {
                    dynamic_sidebar( "footer-section" );
                } 
                ?>
